...
axios.get(`${server}/task/my`, {
 ...
 toast.error(e.response.data.message)
  ...
  return (
    <Box className="mytask" sx={{marginBottom : '4rem' }}> <Typography textAlign={"center"} padding={3} fontSize={28} mt={3} sx={{textShadow : '0 0 rgba( 0 0 345 0'}}> Embrace Productivity, {user.name} Your Task Master Awaits Your Command.</Typography>
